...
>
	...
	>
		...
		<p
			id="mision"
			class="mt-4 max-w-[21rem] text-center text-sm sm:max-w-[28rem] sm:text-left md:max-w-[28rem] md:text-left md:text-base lg:ml-3 lg:mt-5 lg:max-w-[25rem] lg:text-left lg:text-[1rem]"
		>
